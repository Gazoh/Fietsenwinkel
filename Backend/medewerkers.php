...
<div id="wrapper" class="toggled">
        ...
        <div class="card text-black mb-5 mt-5">
            <div class="card-header" id="card-header">
                ...
                <button class="foo-button mdc-button mdc-button--raised mdc-ripple-upgraded uitvoeren" id="uitvoeren">
                    <span class="mdc-button__label uitvoerenLabel">Uitvoeren</span>
                </button>
                <button class="foo-button mdc-button mdc-button--raised mdc-ripple-upgraded iconLabel" id="uitvoeren">
    ...
    <div class="modal fade" id="bijwerkenModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Medewerker Aanpassen</h5>
                </div>
                <div class="modal-body p-4">
                    <form action="Controllers/medewerker_toevoegen.php" method="POST" id="addMedewerker">
                        <!-- Voornaam & Achternaam -->
    ...
    <div class="modal fade" id="bekijkenModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Medewerker Bekijken</h5>
                </div>
                <div class="modal-body p-4">
                    <form action="Controllers/medewerker_toevoegen.php" method="POST" id="addMedewerker">
                        <!-- Voornaam & Achternaam -->
                        <div class="row justify-content-center">
                            <div class="mdc-text-field mr-2 mt-2">
                                <input type="text" name="firstnameInput" id="firstnameInputBekijken" class="mdc-text-field__input" value="" disabled="">
                                <label class="mdc-floating-label mdc-floating-label--float-above" for="pre-filled">
                                    Voornaam
                                </label>
                                <div class="mdc-line-ripple"></div>
                            ...
                            <div class="mdc-text-field mt-2">
                                <input type="text" name="lastnameInput" id="lastnameInputBekijken" class="mdc-text-field__input" value="" disabled="">
                                <label class="mdc-floating-label mdc-floating-label--float-above" for="pre-filled">
                                    Achternaam
                                </label>
                                <div class="mdc-line-ripple"></div>
                            ...
                            <div class="mdc-text-field mt-2 w-91">
                                <input type="email" name="emailInput" id="emailInputBekijken" class="mdc-text-field__input" value="" disabled="">
                                <label class="mdc-floating-label mdc-floating-label--float-above" for="pre-filled">
                                    Email
                                </label>
                                <div class="mdc-line-ripple"></div>
